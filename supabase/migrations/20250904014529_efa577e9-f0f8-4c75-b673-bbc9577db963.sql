...
-- Insert comprehensive family and student data with proper hexadecimal UUIDs
INSERT INTO user_profiles (user_id, email, user_type) VALUES
-- Family accounts with proper hexadecimal UUIDs
...
-- Student accounts with proper hexadecimal UUIDs
('a1111111-1111-1111-1111-111111111111', 'yuki.sunshine@student.com', 'student'),
('a2222222-2222-2222-2222-222222222222', 'marie.paris@student.com', 'student'),
('a3333333-3333-3333-3333-333333333333', 'pedro.adventure@student.com', 'student'),
('a4444444-4444-4444-4444-444444444444', 'anna.dreams@student.com', 'student'),
('a5555555-5555-5555-5555-555555555555', 'lucas.explorer@student.com', 'student'),
('a6666666-6666-6666-6666-666666666666', 'sofia.artist@student.com', 'student'),
('a7777777-7777-7777-7777-777777777777', 'chen.curious@student.com', 'student'),
('a8888888-8888-8888-8888-888888888888', 'emma.wanderer@student.com', 'student');
...
('ab111111-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', 'The Johnson Family', 'Portland, Oregon', '8 years of hosting experience', '$800-1200/month',
...
('ab222222-2222-2222-2222-222222222222', 'f2222222-2222-2222-2222-222222222222', 'The Chen Family', 'San Francisco, California', '5 years of hosting experience', '$1200-1800/month',
ARRAY['Urban Living', 'Technology', 'Healthy Lifestyle', 'Career Development'],
true,
'Michael and Lily Chen moved to San Francisco 10 years ago and understand the challenges of adapting to a new culture. Our modern downtown condo offers students the excitement of city life while providing a supportive family environment. Michael works in tech, and Lily is a yoga instructor. We love exploring the city neighborhoods, trying diverse cuisines, and sharing our journey of building a life in America.',
...
('ab333333-3333-3333-3333-333333333333', 'f3333333-3333-3333-3333-333333333333', 'The Martinez Family', 'Austin, Texas', '12 years of hosting experience', '$700-1000/month',
ARRAY['Music', 'Cooking', 'Family Traditions', 'Community'],
true, 
'Bienvenidos! We are Carlos, Rosa, and our daughter Sofia (16). Our home reflects our Mexican heritage blended with American traditions. Rosa homemade tamales are legendary among our students, and Carlos teaches guitar on weekends. Our house is filled with music, laughter, and the aroma of authentic Mexican cuisine. We have a beautiful garden where Rosa grows herbs and vegetables for our family meals.',
...
('ab444444-4444-4444-4444-444444444444', 'f4444444-4444-4444-4444-444444444444', 'The Williams Family', 'Boulder, Colorado', '6 years of hosting experience', '$900-1300/month',
ARRAY['Nature', 'Sustainability', 'Hiking', 'Mindfulness'],
true,
'Tom and Jennifer Williams live in a charming cottage-style home with breathtaking mountain views. We are passionate about sustainable living and outdoor adventures. Our home features solar panels, a vegetable garden, and hiking trails right from our backyard. Tom is a park ranger, and Jennifer teaches environmental science. We love sharing Colorado natural beauty with our students through weekend camping trips and hiking excursions.',
...
('ab555555-5555-5555-5555-555555555555', 'f5555555-5555-5555-5555-555555555555', 'The Nakamura Family', 'Seattle, Washington', '10 years of hosting experience', '$1000-1400/month',
...
('ab777777-7777-7777-7777-777777777777', 'f7777777-7777-7777-7777-777777777777', 'The Garcia Family', 'San Diego, California', '7 years of hosting experience', '$1100-1500/month',
ARRAY['Art', 'Beach Life', 'Creativity', 'Wellness'],
true,
'Diego and Carmen Garcia are professional artists living in a colorful beach cottage. Our home is filled with original artwork, and we have a studio where students can explore their creativity. Carmen teaches pottery, and Diego is a muralist. We are just two blocks from the beach, and sunset walks are a daily ritual. Our home reflects our artistic spirit with vibrant colors, handmade furniture, and an inspiring creative atmosphere.',
...
('ab888888-8888-8888-8888-888888888888', 'f8888888-8888-8888-8888-888888888888', 'The Taylor Family', 'Minneapolis, Minnesota', '9 years of hosting experience', '$750-1100/month',
...
'Living through four distinct seasons teaches students about cycles of life and finding joy in every moment. We love sharing Minnesota natural beauty and helping students experience authentic American family traditions.',
...
('b1111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 'Yuki Tanaka', 'University of Oregon', 20, 'Tokyo, Japan', 'Art student passionate about cultural exchange and photography. Loves cooking and outdoor adventures.', 'https://images.unsplash.com/photo-1494790108755-2616b612b08f?w=400'),
('b2222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222222', 'Marie Dubois', 'UC Berkeley', 22, 'Lyon, France', 'Business major fascinated by American entrepreneurship. Enjoys hiking and learning about sustainable living.', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400'),
('b3333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333333', 'Pedro Silva', 'UT Austin', 21, 'São Paulo, Brazil', 'Music production student who loves learning about different musical traditions and family cooking.', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400'),
('b4444444-4444-4444-4444-444444444444', 'a4444444-4444-4444-4444-444444444444', 'Anna Kowalski', 'University of Colorado Boulder', 19, 'Warsaw, Poland', 'Environmental science student passionate about mountain activities and sustainable living.', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400'),
('b5555555-5555-5555-5555-555555555555', 'a5555555-5555-5555-5555-555555555555', 'Lucas Chen', 'University of Washington', 23, 'Vancouver, Canada', 'Computer science graduate student interested in meditation, art, and cross-cultural understanding.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400'),
('b6666666-6666-6666-6666-666666666666', 'a6666666-6666-6666-6666-666666666666', 'Sofia Rodriguez', 'Vanderbilt University', 20, 'Madrid, Spain', 'Psychology student fascinated by American rural culture and equestrian activities.', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400'),
('b7777777-7777-7777-7777-777777777777', 'a7777777-7777-7777-7777-777777777777', 'Chen Wei', 'UC San Diego', 21, 'Beijing, China', 'Fine arts student exploring American artistic expression and beach culture.', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400'),
('b8888888-8888-8888-8888-888888888888', 'a8888888-8888-8888-8888-888888888888', 'Emma Hansen', 'University of Minnesota', 22, 'Copenhagen, Denmark', 'Exchange student studying environmental policy, loves seasonal activities and outdoor sports.', 'https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=400');