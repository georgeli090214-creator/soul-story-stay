...
-- Sample user IDs (you'll need to replace these with actual auth.users IDs after creating accounts)
...
('11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'johnson.family@homestay.com', 'family'),
('22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'chen.family@homestay.com', 'family'),
('33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'martinez.family@homestay.com', 'family'),
('44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'williams.family@homestay.com', 'family'),
('55555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'nakamura.family@homestay.com', 'family'),
('66666666-6666-6666-6666-666666666666', '66666666-6666-6666-6666-666666666666', 'smith.family@homestay.com', 'family'),
('77777777-7777-7777-7777-777777777777', '77777777-7777-7777-7777-777777777777', 'garcia.family@homestay.com', 'family'),
('88888888-8888-8888-8888-888888888888', '88888888-8888-8888-8888-888888888888', 'taylor.family@homestay.com', 'family');
...
(
  ...
  'We believe cultural exchange enriches our childrens lives and helps create global understanding. Hosting students has taught our family so much about the world.',
...
(
  ...
  'Miami is such a multicultural city, and we love being part of students international experience. Plus, who doesnt want to live near the beach?',
...
(
  ...
  NULL,
  'Art and music are universal languages. We love sharing Portlands creative scene and the beautiful nature of Oregon with our students.',
  'Dave is a professional musician and Lisa is a graphic designer. They have a home music studio and art space. Perfect for creative students who want to experience Portlands famous arts scene and natural beauty.'
);
